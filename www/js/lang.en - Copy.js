lang_en = {
	...
	log_out : "Log Out",
	mukeb_information : "Tent Information",
	Location : "Location",
	General_Information : "General Information",
	Address : "Address",
	Images : "Images",
	Add_Image : "Add Image",
	If_you_are_in_tent : "(If you are in Mukeb)",
	Features : "Features",
	Food : "Food",
	Blanket : "Blanket",
	Internet : "Internet",
	...
	Bathroom : "Bathroom",
	Man_capacity : "Man's capacity",
	Woman_capacity : "Woman's capacity",
	...
	Total_Man_capacity : "Total capacity of men",
	Total_Woman_capacity : "Total capacity of women",
	Remaining_Man_capacity : "The remaining men's capacity",
	Remaining_Woman_capacity : "The remaining women's capacity",
	Last_update_time : "Last updated information",
	...
	Tents : "Mukeb",
	Please_enter_the_title_of_the_point : "Please enter the title of the point",
	Please_select_the_starting_point_of_the_move : "Please select the starting point of the move",
	Please_select_the_destination : "Please select the destination",
	No_location_found : "No location found",
	Search_among_places : "Search among places...",
	Found_List : "Found",
	Maybe_This : "Maybe This",
	Save_in_Maybe_This : '<ons-icon icon="fa-star" class="ons-icon fa-star fa"></ons-icon>Save in "Maybe This"',
	Nothing_Found : "Nothing Found",
	filter : "Select Type <ons-icon icon='fa-filter' class='ons-icon fa-filter fa'></ons-icon>",
	Load_More : "Load More <ons-icon icon='fa-cloud-download' class='ons-icon fa-cloud-download fa'></ons-icon>",
